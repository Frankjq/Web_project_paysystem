...
function get(obj) {
      var poststr = "id=" + encodeURI( document.getElementsByName("id").value );
                    ...
                    "&datefeesub=" + encodeURI( document.getElementsByName("datefeesub").value );
...
<h3 style="color: navy;" align="center"><B> New Registration </B></h3>
<div id="box">
...
<tr><td><B>Date of Submission:</B></td><td><input type="text" name="datefeesub" ></input></td></tr>
